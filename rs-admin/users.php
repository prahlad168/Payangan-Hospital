<?php
/**
 * Manajemen User - RS Payangan Hospital
 */
...
// Demo data users
$users_list = [
    ['id' => 1, 'username' => 'direktur', 'nama' => 'dr. Anak Agung Gede Jaya Kesuma, Sp.PD', 'email' => 'direktur@payanganhospital.id', 'role' => 'direktur', 'dept' => 'Direksi', 'status' => 'active', 'last_login' => '2026-07-04 08:30'],
    ['id' => 2, 'username' => 'admin', 'nama' => 'Administrator Sistem', 'email' => 'admin@payanganhospital.id', 'role' => 'admin', 'dept' => 'IT', 'status' => 'active', 'last_login' => '2026-07-04 09:15'],
    ['id' => 3, 'username' => 'karyawan', 'nama' => 'Staf Rumah Sakit', 'email' => 'staf@payanganhospital.id', 'role' => 'karyawan', 'dept' => 'Umum', 'status' => 'active', 'last_login' => '2026-07-04 08:00'],
    ['id' => 4, 'username' => 'perawat1', 'nama' => 'Ni Made Suarningsih, Amd.Kep', 'email' => 'perawat1@payanganhospital.id', 'role' => 'karyawan', 'dept' => 'Perawatan', 'status' => 'active', 'last_login' => '2026-07-04 07:45'],
    ['id' => 5, 'username' => 'kasir1', 'nama' => 'I Wayan Koster', 'email' => 'kasir1@payanganhospital.id', 'role' => 'karyawan', 'dept' => 'Keuangan', 'status' => 'active', 'last_login' => '2026-07-03 16:30'],
];
?>
<!DOCTYPE html>
<html lang="id">
<head>
    ...
    <title>Manajemen User - RS Payangan Hospital</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .stat-box {
            background: var(--bg-light); padding: 20px; border-radius: 12px; text-align: center;
        }
        .stat-box .number { font-size: 2rem; font-weight: 700; color: var(--primary); }
        .stat-box .label { font-size: 0.8rem; color: var(--text-muted); margin-top: 5px; }
        ...
        .user-info-cell h4 { font-size: 0.95rem; margin-bottom: 2px; }
        .user-info-cell p { font-size: 0.8rem; color: var(--text-muted); }
        
        .role-badge {
            display: inline-flex; align-items: center; gap: 5px;
            padding: 5px 12px; border-radius: 20px; font-size: 0.75rem; font-weight: 500;
        }
        .role-direktur { background: rgba(201, 168, 108, 0.2); color: #c9a86c; }
        .role-admin { background: rgba(26, 95, 90, 0.1); color: var(--primary); }
        .role-karyawan { background: rgba(108, 117, 125, 0.1); color: #6c757d; }
    ...
    <aside class="sidebar" id="sidebar">
        <div class="sidebar-menu">
            ...
            <div class="sidebar-section">
                ...
                <a href="users.php" class="sidebar-link active"><i class="fas fa-user-cog"></i> Manajemen User</a>
    ...
    <main class="main-content">
        <div class="page-header">
            <div>
                ...
                <p class="breadcrumb">
                    <a href="dashboard.php">Dashboard</a> / Manajemen User
                </p>
            </div>
        ...
        <div class="stats-row">
            ...
            <div class="stat-box">
                <div class="number"><?php echo count($users_list) - 2; ?></div>
            ...
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><code style="background: var(--bg-light); padding: 3px 8px; border-radius: 4px;"><?php echo $user['username']; ?></code></td>
                        <td>
                            <span class="role-badge role-<?php echo $user['role']; ?>">
                                <?php
                                $role_icons = ['direktur' => 'fa-crown', 'admin' => 'fa-shield-alt', 'karyawan' => 'fa-user'];
                                ?>
                                <i class="fas <?php echo $role_icons[$user['role']]; ?>"></i>
